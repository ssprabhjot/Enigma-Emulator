...
namespace Enigma
{
	...
	public class Settings : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent() {
            ...
            this.btnSelect.Location = new System.Drawing.Point(152, 37);
            ...
            this.btnDown.Location = new System.Drawing.Point(152, 149);
            this.btnDown.Name = "btnDown";
            this.btnDown.Size = new System.Drawing.Size(40, 29);
            ...
            this.btnOk.Location = new System.Drawing.Point(256, 305);
            ...
            this.btnDeselect.Location = new System.Drawing.Point(152, 74);
            this.btnDeselect.Name = "btnDeselect";
            this.btnDeselect.Size = new System.Drawing.Size(40, 30);
            ...
            this.btnUp.Location = new System.Drawing.Point(152, 111);
            ...
            "Reflector C = ABCDEFGHIJKLMNOPQRSTUVWXYZ"});
            this.cmbReflector.Location = new System.Drawing.Point(16, 275);
            ...
            this.lblRotorStructure.Location = new System.Drawing.Point(8, 39);
            this.lblRotorStructure.Name = "lblRotorStructure";
            this.lblRotorStructure.Size = new System.Drawing.Size(296, 21);
            ...
            "Rotor IV",
            "Rotor V"});
            this.lstAvailableRotors.Location = new System.Drawing.Point(16, 30);
            this.lstAvailableRotors.Name = "lstAvailableRotors";
            this.lstAvailableRotors.Size = new System.Drawing.Size(120, 147);
            ...
            // lstSelectedRotors
            // 
            this.lstSelectedRotors.Location = new System.Drawing.Point(208, 30);
            this.lstSelectedRotors.Name = "lstSelectedRotors";
            this.lstSelectedRotors.Size = new System.Drawing.Size(120, 147);
		...
		void SettingsLoad(object sender, System.EventArgs e)
		{
			...
			ttSelect.SetToolTip(btnSelect,"Selected Rotor");
			ttDeselect.SetToolTip(btnDeselect,"Deselect rotor");
			ttUp.SetToolTip(btnUp,"Move rotor one up");
			ttDown.SetToolTip(btnDown,"Move rotor one down");
		...
		{
			if(lstAvailableRotors.SelectedIndex<0){
				MessageBox.Show(this,"Selection not made!","Attention!",MessageBoxButtons.OK,MessageBoxIcon.Exclamation);
				return;
			}
		...
		void BtnOkClick(object sender, System.EventArgs e)
		{
			if(lstSelectedRotors.Items.Count!=3){
				MessageBox.Show(this,"Enigma needs 3 rotors!","Attention!",MessageBoxButtons.OK,MessageBoxIcon.Exclamation);
				return;
			}
